...
export interface MockV3Aggregator extends BaseContract {
    ...
    functions: {
        ...
        updateAnswer(_answer: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        updateRoundData(_roundId: BigNumberish, _answer: BigNumberish, _timestamp: BigNumberish, _startedAt: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
